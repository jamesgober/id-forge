...
```toml
[dependencies]
id-forge = "0.9.2"                                          # all schemes (default)
id-forge = { version = "0.9.2", default-features = false } # nothing (compile errors if you use anything)
id-forge = { version = "0.9.2", default-features = false, features = ["uuid"] }  # just UUIDs
```
